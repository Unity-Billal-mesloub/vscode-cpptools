...
Prerequisite steps:
  * Clone the release branch of [this](https://github.com/Unity-Billal-mesloub/vscode-cpptools) repository.
      * git clone -b release https://github.com/Unity-Billal-mesloub/vscode-cpptools
  ...
  * Open the **Extension** folder in Visual Studio Code and press F5. This will launch a VS Code Extension Host window and activate the TypeScript debugger. You can set breakpoints on the extension source code and debug your scenario.
      ...
      * Then, you can follow the instructions in this [comment in a discussion about building this extension locally](https://github.com/Unity-Billal-mesloub/vscode-cpptools/discussions/8745#discussioncomment-2091563).
      ...
      * Feel free to use [the Discussions tab of this repository](https://github.com/Unity-Billal-mesloub/vscode-cpptools/discussions) if you have any further questions on building this extension locally.
